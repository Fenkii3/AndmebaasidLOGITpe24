...
(1, 'Priit', 'Mets', '573498', 'priit.mets@gmail.com', 'Linnu Tee 17', 'Tallinn', 'Eesti', '74297');
...
CREATE TABLE `orders` (
  ...
  `order_status` varchar(10) DEFAULT NULL CHECK (`order_status` = 'tehtud' or `order_status` = 'tegemata'),
...
(1, 1, 'Tehtud', '2026-04-21', '2026-05-10', '0000-00-00', 1, 1),
(2, 1, 'Tehtud', '2026-04-21', '2026-04-30', '2026-04-29', 1, 1);
...
(1, 'Riho', 'Toomingas', 'riho.toomingas@gmail.com', '52142942', b'1', 1, b'0');
...
(1, 'Sportland', '5890387', 'spotland@gmail.com', 'Järveotsa 87', 'Tallinn', 'Eesti', '75643');
...
--
ALTER TABLE `stocks`
  ADD CONSTRAINT `stocks_ibfk_1` FOREIGN KEY (`store_id`) REFERENCES `products` (`product_id`);
COMMIT;
